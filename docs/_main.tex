...
\chapter*{{[}Name of Workshop{]}}\label{name-of-workshop}
\addcontentsline{toc}{chapter}{{[}Name of Workshop{]}}
...
\section{{[}USE BELOW FOR REFERENCE, DELETE FOR THE ACTUAL WORKSHOP{]}}\label{use-below-for-reference-delete-for-the-actual-workshop}
...
Click \href{}{here} for your prework!
...
\caption{Photo of Michelle Brazas}
\end{figure}
