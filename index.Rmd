--- 
title: "{{Workshop Name}} {{Year}}"
author: "Faculty: {{Faculty Names Separated By Commas}}"
date: "{{Dates}}"
...
description: |
  Workshop website for the {{Year}} {{Workshop Name}} Canadian Bioinformatics Workshop
link-citations: yes
...
Welcome to the {{Year}} {{Workshop Name}} Canadian Bioinformatics Workshop webpage!  
